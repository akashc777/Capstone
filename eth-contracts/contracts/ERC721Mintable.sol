...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(msg.sender == getOwner(), "The account doesn't belongs to owner");
        _;
    }
...
contract Pausable is Ownable {
    ...
    modifier whenNotPaused() {
        require(_paused != true, "Owner has paused the contract");
        _;
    }

    modifier paused() {
        require(_paused == true, "Owner has NOT paused the contract");
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to !=  _tokenOwner[tokenId], "The given address id the owner of the given token id");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == getOwner() || isApprovedForAll(msg.sender, to), "caller is not the owner of the contract OR approval is not given to the operator");
    ...
    function setApprovalForAll(address to, bool approved) public {
        require(to != msg.sender, "no need to set approval for token owner");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(_tokenOwner[tokenId] != address(0) || to != address(0), "token already exists or address is invalid");
...
contract CustomERC721Token is ERC721Metadata("MindPeace", "MNP", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
